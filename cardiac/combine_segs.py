...
if __name__ == "__main__":
    ...
    for i in range(len(imgs)):
        ...
        vf.write_img(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_seg.vti'), segmentation)
        ...
        # Save combined segmentation
        vf.write_img(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_seg_combined_area.vti'), combined_seg)
        vf.write_img(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_vasc_combined_area.vti'), new_vasc)
        ...
        # Save polydata
        vf.write_geo(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_seg_combined_area.vtp'), poly)
        ...
        vf.write_geo(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_seg_combined_area_smoothed.vtp'), poly)
        ...
        vf.write_geo(segs_dir + imgs[i].split('/')[-1]
                     .replace('.vti', '_seg_combined_area_blood_aorta.vtp'),
