...
# Example usage:
input_folder = '/global/scratch/users/stanleychmwong/datasets/aorta_datasets/mic23_aorta_dataset/centerlines/'
output_folder = '/global/scratch/users/stanleychmwong/datasets/aorta_datasets/mic23_aorta_dataset_updated_units/centerlines/'
